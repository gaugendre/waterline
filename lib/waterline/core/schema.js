...
var typePattern = require('../utils/typepattern');
...
Schema.prototype.objectAttribute = function(value, strict) {
  var attr = {};
  ...
  for(var key in value) {
    switch(key) {
      ...
      case 'type':
        ...
        //
        // Allow custom types like simple features access
        attr.type = strict ? ~types.indexOf(value[key]) ? value[key] : 'string' : ~types.indexOf(value[key]) || typePattern.test(value[key]) ? value[key] : 'string';
        break;
