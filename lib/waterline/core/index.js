...
_.extend(Core.prototype, {
  ...
  _initialize: function(options) {
    ...
    // Configure anchor with regular schema
    // Custom field types as like simple features
    // considered as string
    var _attributes = {};
    for(var key in this._schema.schema) {
       _attributes[key] = this._schema.objectAttribute(this._schema.schema[key], true); // stric mode
    }
    this._validator.initialize(_attributes, this.types);
